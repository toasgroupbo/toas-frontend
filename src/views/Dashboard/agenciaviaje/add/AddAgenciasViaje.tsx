    ...
    if (isEditing && lugarExistente && !cargandoLugarExistente) {
      try {
        ...
        reset({
          ...
          horarios_es: servicio?.horarios_es || '',
          horarios_en: servicio?.horarios_en || '',
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Grid container spacing={6}>
          ...
          <Grid size={{ xs: 12 }}>
            <Card>
              <CardHeader
                title='✈️ Información de la Agencia de Viaje'
                subheader='Complete los detalles específicos de la agencia de viaje'
              />
              <CardContent>
                <Grid container spacing={6}>
                  <Grid size={{ xs: 12, sm: 6 }}>
                    <CustomTextField
                      ...
                      helperText={errors.horarios_es?.message || 'Máximo 85 caracteres - Se traduce automáticamente'}
                  ...
                  <Grid size={{ xs: 12, sm: 6 }}>
                    <CustomTextField
                      ...
                      helperText={errors.horarios_en?.message || 'Máximo 85 caracteres - Se traduce automáticamente'}
                  ...
                  <Grid size={{ xs: 12, sm: 4 }}>
                    <CustomTextField
                      ...
                      helperText={errors.celular?.message || 'Máximo 8 dígitos (solo números)'}
                    />
                  </Grid>
