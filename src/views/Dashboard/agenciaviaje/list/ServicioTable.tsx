...
const ServicioTable = () => {
  ...
  const { lugares, total, isLoading, error, useGetSubcategoriasServicio, useDeleteServicio, refetchLugaresServicio } =
    useServicio(currentPage, pageSize, searchQuery, 43)
      ...
      columnHelper.accessor('actions', {
        ...
        cell: ({ row }) => (
          <div className='flex items-center gap-2'>
            <IconButton
              component={Link}
              href={`/agenciaviaje/edit/${row.original.id}`}
              size='small'
              sx={{
                color: 'primary.main',
  ...
  return (
    <Card>
      <div className='flex flex-wrap justify-between gap-4 p-6'>
        <div className='flex flex-wrap gap-4 items-center'>
          <DebouncedInput
            ...
            placeholder='Buscar Agencias de Viaje...'
        ...
        component={() => (
          <div className='flex justify-between items-center flex-wrap pli-6 border-bs bs-auto plb-[12.5px] gap-2'>
            <Typography color='text.disabled'>
              {`Mostrando ${(currentPage - 1) * pageSize + 1} a ${Math.min(currentPage * pageSize, total)} de ${total} Agencias de Viaje`}
            </Typography>
            <Pagination
              shape='rounded'
              color='primary'
      ...
      >
        <DialogTitle id='alert-dialog-title'>¿Eliminar agencia de viaje permanentemente?</DialogTitle>
        <DialogContent>
          <DialogContentText id='alert-dialog-description'>
            {lugarAEliminar && (
              <>
                Estás a punto de eliminar la agencia de viaje <strong>&quot;{lugarAEliminar.nombre_es}&quot;</strong>.
                <br />
                <br />
